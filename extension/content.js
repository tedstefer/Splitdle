...
function buildHUD() {
  ...
  hud.id = 'splitdle-hud';
  hud.style.cssText = 'position:fixed;top:16px;right:16px;width:220px;background:rgba(15,15,15,0.95);border:1px solid #e94560;border-radius:12px;padding:14px;z-index:999999;font-family:Arial,sans-serif;color:#fff;box-shadow:0 4px 20px rgba(0,0,0,0.5);';
