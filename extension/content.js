...
function buildHUD() {
  ...
  logo.style.cssText = 'color:#e94560;font-size:13px;font-family:"Courier New",Courier,monospace;font-weight:900;text-align:center;letter-spacing:3px;margin-bottom:4px;padding-bottom:8px;border-bottom:1px solid #333;position:relative;';
